...
class _HomePageState extends State<HomePage>
    with SingleTickerProviderStateMixin ,TickerProviderStateMixin<HomePage>, WidgetsBindingObserver{
   LatLng center;
  String _identifier;
  double _radius = 50.0;
 ...
 Future<String> getJsondata() async { 
  ...
  void _addgeofence() {
    bg.BackgroundGeolocation.addGeofence(bg.Geofence(
        ...
        extras: {'radius': _radius, 'center': {'latitude': currentlat, 'longitude': currentlong}} // meta-data for tracker.transistorsoft.com
    )).then((bool success) {
